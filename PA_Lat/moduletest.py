...
Commande_2 = "Axis x=0 y=25000 chi=135" #Test d'une capture d'axe
Commande_3 = "Axis x=0 y=0 chi=180" #Verification qu'il ne dépasse pas le roll max

Vent_1 = "WindComponent VWind=0 dirWind=0"
Vent_2 = "WindComponent VWind=50 dirWind=0"
Vent_3 = "WindComponent VWind=100 dirWind=89"
...
def state_vector(agent, *larg) :
    ...
    if c ==0 :
        envoie_message(Situation_1, Vent_2)
        IvySendMsg("MagneticDeclination = 13.9")
